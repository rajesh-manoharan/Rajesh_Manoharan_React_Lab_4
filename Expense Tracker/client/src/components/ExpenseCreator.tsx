        ...
        return (
            <Form onSubmit={handleNewExpense}>
                <Form.Group className="mb-3" controlId="expenseDescription">
                    ...
                    <Form.Control type="text" placeholder="Enter expense description" ref={descriptionRef} required />
                ...
                <Form.Group className="mb-3" controlId="payeeName">
                    ...
                    <Form.Select aria-label="Default select example" ref={payeeRef} required>
